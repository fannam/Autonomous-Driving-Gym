...
_RUNTIME_CONFIG = RuntimeConfigManager(
    ...
    default_scenario_name="highway_ppo_evolutionary",
    config_path_env_var="PPO_EVOLUTIONARY_CONFIG_PATH",
    scenario_env_var="PPO_EVOLUTIONARY_SCENARIO",
    config_label="ppo-evolutionary",
